...
# l2-tif2nc-yearly-step.sh 2009 Lake-Aral 2009-01-01 2009-01-31  /calvalus/projects/diversity/yearly-seq/ /calvalus/projects/diversity/yearly-nc/
...
request=requests/l2-tif2nc-yearly-${year}-${region}-${minDate}-${maxDate}.xml

cat etc/l2-tif2nc-yearly-template.xml \
